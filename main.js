...
$(function(){
  ...
  var setup = {
    ...
    'screen1': function() { // TODO change some names to be more descriptive
      ...
      var chest2 = new Item('chest2','chest red',300,200,false,true,false,false,true,['rat']).place(); //change rat?
  ...
  var guybrush = {
    ...
    'winningStatues' : ['statue3','statue','statue2'],  // winning combos for statue puzzle
    ...
    'say' : function(inputArr) {   // prepping statements to print
  ...
  var input = {
    ...
    'print' : function(msg, time) { // TODO fix display.
      ...
      if (msg) {
        ...
        console.log($message.offset().left);
        if ($message.offset().left < 0) {
          $message.css('left', '0px');
        } else if ($message.offset().left > 750) {
          $message.css('left', '750px');
        }
      }
    },
